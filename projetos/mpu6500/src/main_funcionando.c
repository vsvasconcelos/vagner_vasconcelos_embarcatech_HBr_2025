...
static void mpu6500_read_raw(int16_t accel[3], int16_t gyro[3], int16_t *temp) {
...
int main() {
    ...
    printf("Hello, MPU6500! Reading raw data from registers...\n");

    // This example will use I2C1 on the default SDA and SCL pins (2, 3 on a Pico)
    ...
    while (1) {
        mpu6500_read_raw(acceleration, gyro, &temp);
